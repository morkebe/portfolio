      ...
      >
        ...
        >
          ...
          >
            ...
            <a href='https://www.instagram.com/mor_k2?igsh=MXNvMmNvNWU3b3B0Mg==' class="p-4">
            <span class="[&>svg]:h-7 [&>svg]:w-7 [&>svg]:fill-[#c13584] p-4">
            ...
            <a href='
            https://www.linkedin.com/in/mor-khoudia-k%C3%A9b%C3%A9-383808257?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app' class="p-4">
            <span class="[&>svg]:h-7 [&>svg]:w-7 [&>svg]:fill-[#0077b5] p-4">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                <path
            ...
            <a href='https://x.com/morkebe06383537' class="p-4">
                
            <span class="[&>svg]:h-7 [&>svg]:w-7 [&>svg]:fill-black p-4">
            <svg
