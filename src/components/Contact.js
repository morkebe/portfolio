...
const Contact = () => {
  return (
    <div>
    <h1 class="text-5xl font-black text-blue-900 dark:text-white text-center py-9">Contacts</h1>
    <div className="grid md:grid-cols-2 py-9  items-center overflow-hidden shadow-lg rounded-3xl max-w-6xl mx-auto  my-6 font-sans">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 12a4.5 4.5 0 1 1-9 0 4.5 4.5 0 0 1 9 0Zm0 0c0 1.657 1.007 3 2.25 3S21 13.657 21 12a9 9 0 1 0-2.636 6.364M16.5 12V8.25" />
          ...
          <p className="  font-medium text-lg px-8">morkhoudiakebe@gmail.com</p>
        </motion.div>
        <motion.div
          className="border border-gray-800  p-6 rounded-lg shadow-md flex items-center"
          initial={{ opacity: 0 }}
